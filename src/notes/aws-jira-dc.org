...
* Introduction
  ...
  erstwhile Jira Server edition. LXP is available on the cloud as
  ...
  This article is not to scare you about the benchmarking test but to
...
* Setup Jira Software Data Center and your App
  ...
  You are done. In a few minutes, your new node will be up. And for the
...
* Develop and execute test-cases
  ...
  Once your single-node setup is ready, you are required to upload the
  ...
  Again the results are saved in
